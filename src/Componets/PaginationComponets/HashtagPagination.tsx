...
function HashtagPagination() {
    ...
    const handleSelect = (value: string) => {
        ...
        dispatch(setPaginationHastaglList({
            ...pagination,
            current_page: 1,
    ...
    return (
         <div className="flex justify-between w-[600px]   md:w-full  px-2  md:px-10 py-6  bg-primary">
            ...
            <div className="relative flex gap-2 items-center" ref={dropdownRef}>
                <div
                    className="border border-bordercolor bg-primary rounded-xl flex gap-2 items-center px-3 py-1 cursor-pointer"
                ...
                {isDropdownOpen && (
                    <div className="absolute left-0 z-50 mb-2  border text-textcolor  bg-primary border-bordercolor rounded-lg shadow-lg bottom-full w-max">
                        {options.map((option) => (
                            <p
                                key={option}
                ...
                <p className="text-paginationtextcolor font-poppins text-sm ">
                    Showing <span className="font-semibold   text-paginationtextcolor text-sm">
                ...
                {[...Array(totalPages)].map((_, index) => {
                    ...
                    return (
                        <button
                            ...
                            ${activePage === page ? "text-white bg-button-gradient bggradient  cursor-pointer" : "text-textcolor   cursor-pointer hover:bg-gray-200"}`}
