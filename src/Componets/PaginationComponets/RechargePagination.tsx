...
function RechargePagination() {
    const dispatch = useAppDispatch();
    const pagination = useAppSelector((state) => state.RechargeListPaginationSlice);



console.log("paginationpaginationpaginationpagination!!monu",pagination)
    ...
    const handleSelect = (value: string) => {
        ...
        dispatch(setPaginationRechargelList({
            ...pagination,
            current_page: 1,
                ...
                {[...Array(totalPages)].map((_, index) => {
                    ...
                    return (
                        <button
                            ...
                            ${activePage === page ? "text-white  cursor-pointer   bg-button-gradient bggradient  cursor-pointer" : "text-textcolor  hover:bg-gray-200"}`}
...
export default RechargePagination;
