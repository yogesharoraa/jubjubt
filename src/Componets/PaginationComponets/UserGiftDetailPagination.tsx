...
function UserGiftDetailPagination() {
    ...
    const handleSelect = (value: string) => {
        ...
        dispatch(setPaginationUserGiftlList({
            ...pagination,
            current_page: 1,
    ...
    return (
         <div className="flex justify-between w-[600px]   md:w-full  px-2  md:px-10 py-6  bg-primary">
            ...
            <div className="relative flex gap-2 items-center" ref={dropdownRef}>
                ...
                {isDropdownOpen && (
                    <div className="absolute left-0 z-50 mb-2  bg-primary border-bordercolor text-textcolor rounded-lg shadow-lg bottom-full w-max">
                        {options.map((option) => (
                            <p
                                key={option}
...
export default UserGiftDetailPagination;
