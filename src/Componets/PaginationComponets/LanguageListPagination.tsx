...
function LanguageListPagination() {
    ...
    const handleSelect = (value: string) => {
        ...
        dispatch(setPaginationLanguageList({
            ...pagination,
            current_page: 1,
            ...
            <div className="flex items-center gap-1">
                ...
                {[...Array(totalPages)].map((_, index) => {
                    ...
                    return (
                        <button
                            key={page}
                            className={`text-sm font-poppins px-3 py-1 rounded-full transition-all duration-200    cursor-pointer 
...
export default LanguageListPagination;
