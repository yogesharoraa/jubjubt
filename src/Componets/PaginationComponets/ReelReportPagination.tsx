...
function ReelReportPagination() {
    ...
    const handleSelect = (value: string) => {
        ...
        dispatch(setPaginationRellReportlList({
            ...pagination,
            current_page: 1,
    ...
    return (
         <div className="flex justify-between w-[600px]   md:w-full  px-2  md:px-10 py-6  bg-primary">
            ...
            <div className="relative flex gap-2 items-center" ref={dropdownRef}>
                ...
                {isDropdownOpen && (
                    <div className="absolute left-0 z-50 mb-2  border dark:border-[#1F1F1F] bg-primary border-bordercolor rounded-lg shadow-lg bottom-full w-max">
                        {options.map((option) => (
                            <p
                                key={option}
...
export default ReelReportPagination;
