...
const options1 = [
    ...
    },
    {
        ...
        subOptions: [
            ...
            { name: "Auto Uploader", path: "/auto-poster", src: PostList1, src1: PostList2, srch: PostListh },
           // inside options1 -> REEL -> subOptions ... replace Ads Manager entry with:
{
  name: "Ads Manager",
  path: "/ads-manager",
  src: PostList1,
  src1: PostList2,
  srch: PostListh,
  // add nested sub-items for Active / Inactive
  sub: [
    { name: "Active Ads", path: "/ads-manager?status=active" },
    { name: "Pending Ads", path: "/ads-manager?status=inactive" }
  ],
},
            ...
            <div className="flex flex-col h-full">
                ...
                <div className="flex items-center justify-between px-6 pt-8">
                    <div className="flex items-center gap-2">
                        ...
                        {!isSidebarOpen && <img src={data?.data?.app_logo_light} alt="jubjub" className="w-[75px] " />}
                    </div>
                    {/* Arrow */}
                                                        ...
                                                        {({ isActive }) => (
                                                            <div className="flex items-center  ">
                                                                ...
                                                                <div className="relative w-5 h-5">
                                                                    <img src={isActive ? item.src1 : item.src} className={`w-5 h-5 dark:group-hover:hidden  ${isActive ? "colorchange" : ""}`} alt="default" />
                                                                    <img src={isActive ? item.src1 : item.srch} className={`absolute top-0 left-0 hidden w-5 h-5 dark:group-hover:block ${isActive ? "colorchange" : ""}`} alt="hover" />
                                                                </div>
