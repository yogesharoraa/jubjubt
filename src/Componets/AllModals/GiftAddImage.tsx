...
import { updateCoverImageGift } from "../../Appstore/Slice/AddImageSliceGift";
import { useAppSelector } from "../../Hooks/Hooks";

function GiftAddImage() {
  const coverImage = useAppSelector((state) => state.AddImageSliceGift.cover_image);

  console.log(" my selected image val;ues", coverImage)
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    dispatch(updateCoverImageGift(file));
  };

  const handleRemoveFile = () => {
    dispatch(updateCoverImageGift(null));
  };
