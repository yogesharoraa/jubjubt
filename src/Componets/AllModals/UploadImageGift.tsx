...
import { AddGiftImageSliceImage } from "../../Appstore/Slice/AddGiftImageSlice";

function UploadImageGift() {
    const giftImage = useAppSelector((state) => state.AddGiftImageSlice);
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        dispatch(AddGiftImageSliceImage([file]));
    };

    const handleRemoveFile = () => {
        setPreviewImage(null);
        dispatch(AddGiftImageSliceImage([]));
    };
...
export default UploadImageGift;
