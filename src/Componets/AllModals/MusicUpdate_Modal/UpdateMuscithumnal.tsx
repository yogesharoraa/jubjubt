...
import { updateMusicthumnalImageUpdate } from "../../../Appstore/Slice/MusicUpdateThumnalSlice";

function UpdateMuscithumnal() {
    const giftImage = useAppSelector((state) => state.music.data.Records[0]?.music_thumbnail);
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        dispatch(updateMusicthumnalImageUpdate([file]));
    };

    const handleRemoveFile = () => {
        setPreviewImage(null);
        dispatch(updateMusicthumnalImageUpdate([]));
    };
...
export default UpdateMuscithumnal;
