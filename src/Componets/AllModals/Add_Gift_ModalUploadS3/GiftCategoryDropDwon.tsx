...
import { toggleCategorySelectionGift } from "../../../Appstore/Slice/AddGiftCategorySlice";
...
const GiftCategoryDropDwon: React.FC<CategoryDropdownProps> = () => {
    ...
    const selectedCategory = useAppSelector((state) => state.AddGiftCategorySlice.selectedCategory);
    ...
    const handleSelectCategory = (categoryName: string, categoryId: number) => {
        dispatch(toggleCategorySelectionGift({ category_name: categoryName, id: categoryId }));
    };
