...
function TermsConditions(): JSX.Element {
    ...
    useEffect(() => {
        if (appConfig?.terms_and_conditions) {
            setPrivacyPolicy(appConfig?.terms_and_conditions)
        }
    }, [appConfig])
    ...
    const handleAddPolicy = async () => {
        ...
        formData.append('terms_and_conditions', privacyPolicy);
    ...
    return (
        <div className="p-3 space-y-5 md:p-6">
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div>
                    <label className="block mb-2 text-2xl text-textcolor  font-semibold"> Terms & Conditions</label>
